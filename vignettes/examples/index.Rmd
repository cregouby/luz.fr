...
Cette galerie d'exemples utilise luz pour entraîner et valider une gamme d'architectures classique de réseaux d'apprentissage profond. 
La galerie propose également une utilisation de basique à avancée de luz.
...
card <- function(x) {
  ...
  badge_type <- 
    if (x$category == "basique") 
      "success" 
    else if (x$category == "intermédiaire")
      "warning"
    else if (x$category == "avancé")
      "danger"
    else
      "light"
